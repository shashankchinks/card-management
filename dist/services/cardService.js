...
var CardService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, bankModel_1.cardModel.findById(req.params.id).exec()];
                    case 1:
                        getCard = _a.sent();
                        return [2 /*return*/, getCard];
                    case 2:
                        err_2 = _a.sent();
                        console.log(err_2);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, bankModel_1.cardModel.findById(req.params.id).exec()];
                    case 1:
                        updateCardById = _a.sent();
                        updateCardById.name = req.body.name;
                        updateCardById.type = req.body.type;
                        return [4 /*yield*/, updateCardById.save()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, updateCardById];
                    case 3:
                        err_3 = _a.sent();
                        console.log(err_3);
    ...
    CardService.createCard = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var createCard, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        createCard = new bankModel_1.cardModel(req.body);
                        return [4 /*yield*/, createCard.save()];
                    case 1:
                        _a.sent();
